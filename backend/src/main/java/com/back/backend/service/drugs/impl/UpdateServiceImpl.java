...
@Service
public class UpdateServiceImpl implements UpdateDrugsService {

    @Autowired
    DrugsMapper drugsMapper;

    @Override
    public Map<String, String> updateDrugs(Map<String, String> map) {
        Integer id;
        ...
        try {
            ...
            drugsMapper.updateDrugs(new Drugs(id,name,price,purchasePrice,num,introduceDate,productDate,qualityPeriod,supplyUnit,productUnit));
        }catch (Exception e){
            resp.put("info", "error");
            return resp;
        }
